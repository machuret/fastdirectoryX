        ...
        >
          <defs>
            <linearGradient id="half-fill" x1="0" x2="1" y1="0" y2="0">
              <stop offset="50%" style={{ stopColor: 'rgb(250 204 21)' }} />
      ...
      >
        ...
        <ScrollArea className="h-[320px] pr-4">
          <div className="space-y-2">
            {reviews.map((review) => (
              <article
                key={review.reviewer} // Using reviewer as key, assuming it's unique for the demo data. Consider a more robust unique ID if available.
